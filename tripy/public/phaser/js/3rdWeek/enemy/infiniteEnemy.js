...
var InfiniteEnemy = new Phaser.Class({
    ...
    {
        Phaser.GameObjects.Image.call(this, scene, 0, 0, 'enemy9');
        this.speed = 0.1;
        this.health = 3;
        this.born = 0;
        this.direction = 0;
    ...
    spawn: function (shooter, hp, speed, enemyImage)
    {
        //Phaser.GameObjects.Image.call(this, scene, 0, 0, enemyImage);
        this.setTexture(enemyImage);
        this.speed = speed;
        this.health = hp;
        if(this.type ==0){
        ...
        this.player = shooter;
        //this.physics.moveTo(this, shooter, 120);
    },
    ...
    //    this.scene.physics.moveTo(this,playerX, playerY);
