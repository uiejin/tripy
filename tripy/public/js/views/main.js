	...
	.ready(
		function ($) {
			...
			*/
			...
			$(document).on('click', '.nav_admin_li', function () {
				if ($(".hideMenu4").css("display") == "none") {
					$(".hideMenu4").attr("style", "display : block !important");
				} else {
					$(".hideMenu4").attr("style", "display : none !important");
				}
			});
