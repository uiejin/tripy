...
router.get('/getnewpost', function(req, res) {
  ...
  var query = 'SELECT T1.WRITER,T1.NO,T1.MEET_DATE,T1.MEET_TIME,T1.HEADCOUNT,T1.HEADCOUNT_NOW,T1.LIMIT_GENDER,T1.TITLE,T1.ACHIEVENENTSEQ,T3.CATEGORY,T3.SEQ,' +
...
router.get('/getmyparty', function(req, res) {
  ...
  var query = 'SELECT T1.WRITER,T1.NO,T1.MEET_DATE,T1.MEET_TIME,T1.HEADCOUNT,T1.HEADCOUNT_NOW,T1.LIMIT_GENDER,T1.TITLE,T1.ACHIEVENENTSEQ,T3.CATEGORY,T3.SEQ,T4.ATTEND_STATE, ' +
  '(SELECT TITLE FROM PT_ACHIEVEMENT WHERE SEQ = T1.ACHIEVENENTSEQ) AS ACHIEVEMENT_TITLE, ' + 
...
router.get('/getallmypost', function(req, res) {
  ...
  var query = 'SELECT T1.WRITER,T1.NO,T1.MEET_DATE,T1.MEET_TIME,T1.HEADCOUNT,T1.HEADCOUNT_NOW,T1.LIMIT_GENDER,T1.TITLE,T1.ACHIEVENENTSEQ,T3.CATEGORY,T3.SEQ,T4.AREA,T4.COUNTRY, ' +
  '(SELECT TITLE FROM PT_ACHIEVEMENT WHERE SEQ = T1.ACHIEVENENTSEQ) AS ACHIEVEMENT_TITLE, ' + 
